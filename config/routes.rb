Rails.application.routes.draw do
  ...
  get "/repo/:user_name", to: "repositories#index", as: "user" # repo的index
  get "/repo/:user_name/new", to: "repositories#new", as: "new_repo"   # repo的new
  post "/repo/:user_name/create", to: "repositories#create", as: "create_repo" # repo的create
  get "/repo/:user_name/:repository_title", to: "repositories#show", as: "repo"           # repo的show
  get "/repo/:user_name/:repository_title/edit", to: "repositories#edit", as: "edit_repo" # repo的edit
  delete "/repo/:user_name/:repository_title/destroy", to: "repositories#destroy", as: "destroy_repo" # repo的destroy
  patch "/repo/:user_name/:repository_title/update", to: "repositories#update", as: "update_repo"  # repo的update
