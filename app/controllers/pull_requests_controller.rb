class PullRequestsController < ApplicationController
  ...
  def index
    @pull_requests = current_repository.pull_requests.where(status: "Open").order("id DESC")
  ...
  def close_index
    @pull_requests = current_repository.pull_requests.where(status: "Close" || "Merged").order("id DESC")
  end
